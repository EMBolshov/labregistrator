   ...
   class RequestToMDO : IRequestToMDO
    {
        ...
        public WebRequest getQuestinary(List<analyticsrequests> req)
        {
            var questinaryRequest = new QuestinaryRequestModel()
            {
                contract = _contract,
                analyticsrequests = req.ToArray()
            };
            var serializedModel = QuestinaryModelToJson(questinaryRequest);
            try
            {
        ...
        private object QuestinaryModelToJson(QuestinaryRequestModel req)
        {
